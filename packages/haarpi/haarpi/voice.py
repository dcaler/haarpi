...
Shared home: this measurement library lives in haarpi because BOTH tools that train a voice
profile (rabbitHole and raconteur) need it. raconteur.voice re-exports it unchanged.
"""
